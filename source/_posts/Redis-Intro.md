...
- 很乐观，认为什么时候都不会出现问题，所以不会加锁！在更新数据时判断以下，在此期间是否有人修改过这个数据（MySQL 中使用 version 字段）
- 获取 version
- 更新的时候比较 version
...
**测试多线程修改值，使用 wathc 可以当作 redis 的乐观锁操作。**
