...
function reinitializeIcon(icon: SVGElement): SVGElement {
...
<div class="relative z-50" role="menu" tabindex="-1" onmouseleave={hidePanel}>
    <button aria-label="Light/Dark Mode" role="menuitem" class="relative btn-plain scale-animation rounded-lg h-11 w-11 active:scale-90" id="scheme-switch" onclick={toggleScheme} onmouseenter={showPanel}>
        <div class="absolute" class:opacity-0={mode !== LIGHT_MODE}>
            ...
            <Icon id="theme-icon-light" icon="line-md:moon-alt-to-sunny-outline-loop-transition" class="text-[1.25rem]"></Icon>
        </div>
        <div class="absolute" class:opacity-0={mode !== DARK_MODE}>
            <!-- <Icon icon="material-symbols:dark-mode-outline-rounded" class="text-[1.25rem]"></Icon> -->
            <Icon id="theme-icon-dark" icon="line-md:sunny-outline-to-moon-alt-loop-transition" class="text-[1.25rem]"></Icon>
        </div>
